defmodule VendingMachine1Web.UserControllerTest do
  use VendingMachine1Web.ConnCase

  import VendingMachine1.AccountsFixtures

  @create_attrs %{username: "some username", password: "some password", role: "some role", userId: 42, deposit: 42}
  @update_attrs %{username: "some updated username", password: "some updated password", role: "some updated role", userId: 43, deposit: 43}
  @invalid_attrs %{username: nil, password: nil, role: nil, userId: nil, deposit: nil}
