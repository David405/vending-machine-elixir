defmodule VendingMachine1Web.ProductControllerTest do
  use VendingMachine1Web.ConnCase

  import VendingMachine1.ProductsFixtures

  @create_attrs %{amount_available: 42, cost: 42, product_name: "some product_name"}
